      ...
      >
        ...
        <form onSubmit={handleFormSubmit}>
          <div className="wb-confirm-body">
            ...
            {details && (
              <div className="wb-confirm-details-card">
                <p className="wb-confirm-details">{details}</p>
              </div>
            )}
            ...
            {requireInputText && (
              <div className="wb-confirm-input-group">
                <label htmlFor="wb-confirm-input" className="wb-confirm-input-label">
                  To confirm, type <strong className="wb-confirm-input-highlight">{requireInputText}</strong> in the box below:
                </label>
                <input
                  id="wb-confirm-input"
                  ref={inputRef}
